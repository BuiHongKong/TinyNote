# NOTE: App Runner service tạm thời comment vì cần có image trong ECR trước
# Sau khi push image vào ECR (qua GitHub Actions hoặc manual), uncomment và chạy terraform apply
# 
